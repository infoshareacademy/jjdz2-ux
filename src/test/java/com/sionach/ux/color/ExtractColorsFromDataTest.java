...
public class ExtractColorsFromDataTest {
    ...
    public void testExtractColors() throws Exception {
        ...
        testStringList.add("background-color: rgba(255,255,255);");
        testStringList.add("background-color: rgba(255,232,123);");
        testStringList.add("background-color: rgba(234,212,134);");
