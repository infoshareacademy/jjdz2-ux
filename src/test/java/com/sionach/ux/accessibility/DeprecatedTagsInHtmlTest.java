...
public class DeprecatedTagsInHtmlTest {
    ...
    public void findDeprecatedTags() throws Exception {
        ...
        List<String> list = deprecatedTags.findDeprecatedTags("<center><p>Thie text i <strike>strike</strike>. The strike tag is deprecated. The paragraph is centered by deprecated tag center.</p></center> ");
